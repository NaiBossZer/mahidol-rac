        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="hidden xl:flex items-center space-x-6 text-xs sm:text-sm font-normal text-slate-200 shrink-0">
            <Link
              ...
              className={`py-1 transition-colors ${
                isActive("/") ? "text-[#F5B800] font-bold" : "hover:text-[#F5B800]"
              }`}
            >
              หน้าแรก
            </Link>
            <Link
              ...
              className={`py-1 flex items-center gap-1 transition-colors ${
                isActive("/bingo") ? "text-[#F5B800] font-bold" : "hover:text-[#F5B800]"
              }`}
            >
              <span>🎲</span> เกมบิงโก
            </Link>
            <Link
              to="/survey"
              className={`py-1 transition-colors ${
                isActive("/survey") ? "text-[#F5B800] font-bold" : "hover:text-[#F5B800]"
              }`}
            >
              แบบสอบถาม
            </Link>
            <Link
              to="/dashboard"
              className={`py-1 transition-colors ${
                isActive("/dashboard") ? "text-[#F5B800] font-bold" : "hover:text-[#F5B800]"
              }`}
            >
              สรุปผลแบบประเมิน
            </Link>
          ...
          <div className="xl:hidden shrink-0">
            <button
              ...
              className="p-2 text-white hover:text-[#F5B800] focus:outline-none focus:ring-2 focus:ring-[#F5B800] rounded-lg"
          ...
          <div className="xl:hidden mt-3 pt-3 border-t border-white/15 space-y-2 text-sm font-normal">
            <Link
              ...
              className={`block px-3 py-2 rounded-lg transition-colors ${
                isActive("/")
                  ? "bg-white/15 text-[#F5B800] font-bold"
            ...
            <Link
              ...
              className={`block px-3 py-2 rounded-lg transition-colors ${
                isActive("/bingo")
                  ? "bg-[#801818] font-bold text-white"
                  : "hover:bg-white/10 text-white"
              }`}
            >
