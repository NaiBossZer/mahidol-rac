      ...
      <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-2xl dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
        ...
        <div className="space-y-3 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          <p>
            ...
            ขอแจ้งให้ท่านทราบว่า ข้อมูลที่ท่านให้ผ่านแบบประเมินนี้จะถูกเก็บรวบรวมและนำไปใช้เพื่อ
            ประเมินผลการจัดกิจกรรม สรุปผลการดำเนินงาน
            และนำไปปรับปรุงและพัฒนากิจกรรมการเรียนรู้ในอนาคต
            โดยใช้ข้อมูลเท่าที่จำเป็นและเหมาะสมกับวัตถุประสงค์ดังกล่าว
          </p>
          <p>
            ข้อมูลของท่านจะได้รับการเก็บรักษาอย่างเหมาะสมโดยจะไม่สอบถาม ชื่อ-นามสกุล
            และจะไม่นำข้อมูลส่วนบุคคลไปเปิดเผยต่อบุคคลภายนอกเพื่อวัตถุประสงค์อื่น ทั้งนี้
            การตอบแบบประเมินเป็นไปโดยสมัครใจ
          </p>
          ...
          <div className="rounded-lg bg-blue-50 dark:bg-slate-800 p-3.5 text-xs text-slate-700 dark:text-slate-300 border border-blue-100 dark:border-slate-700 leading-normal">
            ...
            <p>
              ...
              ถือว่าท่านรับทราบรายละเอียดการเก็บรวบรวมและใช้ข้อมูลตามที่แจ้งข้างต้น
              และยินยอมให้ผู้จัดกิจกรรมใช้ข้อมูลเพื่อวัตถุประสงค์ในการประเมินและพัฒนากิจกรรมดังกล่าว
            </p>
          </div>
