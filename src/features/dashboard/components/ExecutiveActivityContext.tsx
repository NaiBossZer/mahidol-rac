...
export function ExecutiveActivityContext({ activity, responseCount, loading }: Props) {
  ...
  const formattedDate = new Date(activity.date).toLocaleDateString("th-TH", {
    day: "numeric",
    month: "long",
    year: "numeric",
  });
        ...
        <div className="grid grid-cols-1 md:grid-cols-[minmax(220px,0.9fr)_minmax(0,1.8fr)]">
          <div className="relative min-h-[190px] bg-slate-100">
            {activity.cover_image ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-rac-blue-deep via-rac-lac to-[#961E1E] text-6xl" aria-hidden="true">🦋</div>
            )}
          ...
          <div className="p-5 sm:p-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="rounded-2xl bg-rose-50 px-4 py-3 text-right ring-1 ring-rose-100">
                ...
                <p className="font-mono text-3xl font-bold text-rac-lac">{loading ? "—" : responseCount}</p>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-2xl bg-slate-50 p-3">
                ...
                <p className="mt-1 truncate font-mono text-[10px] font-bold text-slate-700">{activity.id}</p>
              </div>
