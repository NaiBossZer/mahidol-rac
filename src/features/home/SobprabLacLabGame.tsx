...
import type {
  ...
  SeasonCycle,
  MordantType,
} from "@/features/sobprab/engine/SobprabLacLabEngine";
      ...
      <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              {(Object.keys(HOST_INFO) as HostTree[]).map((key) => (
                <SelectCard
                  ...
                  color="#16A34A"
                  onClick={() => actions.setHostTree(key)}
                />
              ))}
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input
                ...
                step={5}
                value={biocontrol}
                onChange={(e) => actions.setBiocontrol(Number(e.target.value))}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  step={0.1}
                  value={pH}
                  onChange={(e) => actions.setPH(Number(e.target.value))}
                  className="w-full"
                ...
                <div className="flex flex-col gap-3">
                  {(Object.keys(MORDANT_INFO) as MordantType[]).map((key) => (
                    <SelectCard
                      ...
                      onClick={() => actions.setMordant(key)}
                    />
                  ))}
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 md:p-6 space-y-4">
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <button
              onClick={() => actions.setProcessRunning(!processRunning)}
