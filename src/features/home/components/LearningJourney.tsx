...
const journey = [
  ...
  },
  {
    ...
    text: "ทำความรู้จักพืชอาศัยที่เกี่ยวข้องกับการเลี้ยงครั่ง และพื้นฐานการเลือกต้นไม้สำหรับการเพาะเลี้ยง",
    href: "/lac/host-plants",
    image: "https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?w=900&h=700&fit=crop",
    alt: "ต้นไม้และพืชอาศัย",
  },
  {
    no: "06",
    icon: "🛡️",
    title: "ศัตรูครั่ง & การป้องกัน",
    text: "เรียนรู้ปัจจัยและศัตรูที่เกี่ยวข้องกับครั่ง พร้อมแนวทางการสังเกตและการจัดการเบื้องต้น",
    href: "/lac/pests",
    image: "https://images.unsplash.com/photo-1473445361085-b9a07f55608b?w=900&h=700&fit=crop",
    alt: "ธรรมชาติและการสังเกตสิ่งมีชีวิต",
  },
  {
    no: "07",
    icon: "🌾",
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
            เรียนรู้เรื่องครั่งเป็นลำดับ จากพื้นฐานและชีววิทยา ไปสู่ระบบนิเวศ พืชอาศัย ศัตรูครั่ง และการเพาะเลี้ยง
          </p>
        </div>
