...
export function LearningJourney() {
  return (
    <section id="learning-journey" className="scroll-mt-24 bg-[#f3eadb] px-4 py-14 sm:py-20" aria-labelledby="learning-journey-title">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 grid gap-4 sm:mt-10 sm:grid-cols-2 lg:grid-cols-3">
          {journey.map((item, index) => (
            <article key={item.no} className="group relative min-h-[300px] min-w-0 overflow-hidden rounded-3xl border border-[#6d4a35]/15 bg-[#2f241d] shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-[#241b17]/45 via-[#241b17]/55 to-[#241b17]/90" aria-hidden="true" />
              <div className="relative z-10 flex h-full min-h-[300px] flex-col p-5 sm:p-6">
                ...
                <span className="mt-4 h-px w-8 bg-[#c58a3a]/60 transition-all duration-300 group-hover:w-14" aria-hidden="true" />
              </div>
            </article>
          ))}
        </div>
