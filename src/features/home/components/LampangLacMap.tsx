...
export function LampangLacMap() {
  ...
  return (
    <section id="lampang-map" className="relative flex min-h-0 scroll-mt-24 items-center overflow-hidden bg-[#f3eadb] px-4 py-14 lg:min-h-[720px] sm:py-20" aria-labelledby="lampang-map-title">
      <div className="pointer-events-none absolute inset-0 bg-cover bg-center opacity-[0.24]" style={{ backgroundImage: `url(${homepageSectionImages.northThai})` }} aria-hidden="true" />
      <div className="pointer-events-none absolute inset-0 bg-[#f3eadb]/55" aria-hidden="true" />
      <div className="relative mx-auto w-full max-w-6xl"><div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:gap-10">
