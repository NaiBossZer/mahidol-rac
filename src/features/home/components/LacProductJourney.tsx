...
export function LacProductJourney() {
  return (
    <section id="lac-product" className="relative flex min-h-0 scroll-mt-24 items-center overflow-hidden bg-[#f3eadb] px-4 py-14 text-[#2a211d] lg:min-h-[720px] sm:py-20" aria-labelledby="lac-product-title">
      <div className="pointer-events-none absolute inset-0 bg-cover bg-center opacity-[0.25]" style={{ backgroundImage: `url(${homepageSectionImages.product})` }} aria-hidden="true" />
