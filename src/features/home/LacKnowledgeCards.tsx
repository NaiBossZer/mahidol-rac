      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {cards.map((card) => (
          <RacCard
            key={card.id}
            variant="interactive"
            className="h-full p-0 overflow-hidden border-slate-200/80"
          >
            <button
              type="button"
              onClick={() => setSelectedCard(card)}
              className={`h-full w-full ${card.bgColor} p-5 text-left flex flex-col justify-between gap-5 cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rac-gold focus-visible:ring-inset`}
            >
              <div className="space-y-3 w-full">
                <div className="flex items-center justify-between">
                  ...
                  <RacBadge tone={card.id === 2 ? "green" : card.id === 3 ? "gold" : "brand"}>
                    {card.tag}
                  </RacBadge>
                </div>
                <h3 className="rac-display text-lg font-bold text-rac-blue group-hover:text-rac-lac transition-colors">
                  {card.title}
                </h3>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 pr-8">
                ...
                <div>
                  <span
                    className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full ${selectedCard.badgeColor}`}
                  >
                    {selectedCard.tag}
                  </span>
