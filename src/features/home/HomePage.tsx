...
export function HomePage() {
  ...
  return (
    <div data-rac-theme="living" className="min-h-screen bg-rac-surface text-slate-800 font-['Mitr'] selection:bg-rac-lac selection:text-white flex flex-col">
      <AppNavbar />
      <main className="grow">
        ...
        <section id="learning-game" className="scroll-mt-24 bg-gradient-to-b from-rac-lac/5 via-white to-rac-lac/5 px-4 py-14 sm:py-16" aria-labelledby="learning-game-title">
          <div className="mx-auto max-w-5xl rounded-3xl border border-rac-lac/15 bg-white p-6 text-center shadow-sm sm:p-10">
            ...
            <h2 id="learning-game-title" className="mt-3 text-2xl font-bold text-slate-800 sm:text-3xl">เรียนรู้ผ่านการเล่น</h2>
            <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-slate-500 sm:text-base">ทดลองความรู้เรื่องครั่งผ่านเกมจำลองและกิจกรรมเชิงโต้ตอบ — เลือกเกม ทดลอง ตัดสินใจ และค้นพบผลลัพธ์ด้วยตัวเอง</p>
            <div className="mt-6"><Link to="/learning-games" className="inline-flex items-center justify-center gap-2 rounded-full bg-rac-lac px-6 py-3 text-sm font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-rac-lac/40 focus:ring-offset-2">เข้าสู่ LAC Learning Games <span aria-hidden="true">→</span></Link></div>
          </div>
        </section>
