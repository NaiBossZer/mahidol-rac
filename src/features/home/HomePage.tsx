...
export function HomePage() {
  ...
  return (
    ...
    >
      ...
      <main className="grow">
        ...
        >
          <div className="mx-auto max-w-6xl space-y-3 text-center">
            <p className="text-xs font-semibold tracking-widest text-rac-lac">
        ...
        <section
          id="bingo-section"
          className="scroll-mt-24 px-4 py-12 bg-gradient-to-b from-transparent via-rac-lac/5 to-transparent"
          aria-labelledby="bingo-game-title"
        >
          <div className="mx-auto max-w-6xl space-y-4 text-center">
            <span className="bg-rac-lac text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
            ...
            <p className="text-sm text-slate-500 max-w-xl mx-auto">
              ท้าทายความรู้ครั่ง 16 คีย์เวิร์ด ตรวจจับสายบิงโกอัตโนมัติ 10 รูปแบบ พร้อมพิธีกรพี่
              M-Guide
            </p>
            <Suspense
              fallback={
        ...
        <section className="max-w-6xl mx-auto px-4 pb-6" aria-labelledby="academic-sources-title">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              ข้อมูลพื้นฐานเรื่องแมลงครั่ง การแปรรูป sticklac, seedlac และ shellac
              ควรอ่านประกอบจากแหล่งอ้างอิงต่อไปนี้
              และตรวจทานความเหมาะสมกับบริบทจังหวัดลำปางโดยผู้เชี่ยวชาญก่อนนำข้อมูลสถิติไปใช้อ้างอิง.
            </p>
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <a
                  className="font-semibold text-rac-lac underline underline-offset-2"
      ...
      <footer className="bg-rac-blue-deep text-slate-300 py-10 border-t border-slate-800 mt-16 text-center">
