...
import { BingoTile, QuestionCard, WinningLine, LeaderboardEntry, HostEmotion } from "@/types/bingo";
...
export const LacBingoGame: React.FC = () => {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto px-2 sm:px-4 py-6 font-['Mitr',sans-serif] text-slate-800">
      ...
      {/* ==================================================================== */}
      <header className="bg-white border-2 border-rac-lac/20 rounded-3xl p-4 sm:p-6 shadow-md mb-6 relative overflow-hidden">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
          {/* Title & Brand */}
          <div className="flex items-center gap-3.5 text-center lg:text-left">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-rac-lac to-rac-blue-light text-white flex items-center justify-center shadow-lg shadow-rac-lac/20 shrink-0">
              <Dices className="w-7 h-7 sm:w-8 sm:h-8 text-rac-gold animate-bounce" />
            </div>
            <div>
              <div className="flex items-center justify-center lg:justify-start gap-2">
                <span className="bg-rac-lac/10 text-rac-lac text-xs font-bold px-2.5 py-0.5 rounded-full border border-rac-lac/20">
                  4x4 BINGO SYSTEM
                </span>
            ...
            <div className="flex bg-slate-100 p-1 rounded-2xl border border-slate-200 text-xs font-semibold">
              <button
                ...
                className={`px-3 py-1.5 rounded-xl transition-all flex items-center gap-1.5 cursor-pointer ${
                  hostMode === "player"
                    ? "bg-rac-lac text-white shadow-sm"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl transition-all flex items-center gap-1.5 cursor-pointer ${
                  hostMode === "screen"
                    ? "bg-rac-blue-light text-white shadow-sm"
                    : "text-slate-600 hover:text-slate-900"
                }`}
              >
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold shadow-md transition-all flex items-center gap-2 cursor-pointer ${
                isPopupOpen
                  ...
                  : "bg-gradient-to-r from-rac-lac to-[#A02020] hover:from-rac-lac-dark hover:to-rac-lac text-white hover:shadow-lg transform hover:-translate-y-0.5 active:translate-y-0"
              }`}
            >
              <Dices className="w-4 h-4 text-rac-gold" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5 pt-4 border-t border-slate-100">
          <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-2.5 sm:p-3 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl font-bold text-rac-lac">
          ...
          <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-2.5 sm:p-3 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl font-bold text-rac-blue-light">
      ...
      {showBingoBanner && (
        <div
          role="status"
          aria-live="polite"
          className="mb-6 bg-gradient-to-r from-rac-gold via-rac-lac to-rac-blue-light p-1 rounded-3xl shadow-xl animate-bounce"
        >
          <div className="bg-white rounded-[22px] p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="bg-rac-lac text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
                  BINGO WINNER!
                </span>
            ...
            <button
              ...
              className="bg-rac-lac hover:bg-rac-lac-dark text-white text-xs font-semibold px-4 py-2 rounded-xl transition-colors cursor-pointer shrink-0"
            >
              เล่นต่อเลย!
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="bg-white border-2 border-slate-200 rounded-3xl p-4 sm:p-6 shadow-sm">
            ...
            <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-rac-lac animate-ping" />
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-gradient-to-br from-rac-blue-light via-rac-blue to-rac-lac rounded-3xl p-5 text-white shadow-lg space-y-4 relative overflow-hidden">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`w-full font-bold py-3 rounded-2xl text-sm transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer ${
                isPopupOpen
                  ...
                  : "bg-rac-gold hover:bg-amber-400 text-rac-blue-light transform hover:-translate-y-0.5 active:translate-y-0"
              }`}
            >
          ...
          <div className="bg-white border-2 border-slate-200 rounded-3xl p-5 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Award className="w-5 h-5 text-rac-lac" />
            ...
            <div className="space-y-2 bg-slate-50 p-3 rounded-2xl border border-slate-200">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="grow bg-white border border-slate-300 rounded-xl px-3 py-1.5 text-xs text-slate-800 focus:outline-none focus:border-rac-lac"
                />
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-colors cursor-pointer shrink-0 ${
                    isSavedToLeaderboard
                      ...
                      : "bg-rac-lac hover:bg-rac-lac-dark text-white"
                  }`}
                >
              ...
              {leaderboard.slice(0, 5).map((entry, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-rac-lac font-mono">{entry.score} pt</span>
                  </div>
                </div>
              ))}
            </div>
