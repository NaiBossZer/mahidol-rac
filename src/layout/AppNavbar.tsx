...
const KNOWLEDGE_LINKS = [
  { key: "nav.knowledge", href: "/lac/what-is-lac", labelKey: "nav.home" },
  { href: "/lac/what-is-lac", labelKey: "nav.knowledge" },
  { href: "/lac/life-cycle", labelKey: "learningJourney.openLesson" },
  { href: "/lac/habitat", labelKey: "learningJourney.openLesson" },
  { href: "/lac/host-plants", labelKey: "learningJourney.openLesson" },
  { href: "/lac/lac-farming", labelKey: "learningJourney.openLesson" },
] as const;
...
const KNOWLEDGE_ITEMS = [
  { label: "ครั่งคืออะไร?", labelEn: "What is lac?", href: "/lac/what-is-lac" },
  { label: "วงจรชีวิต", labelEn: "Life cycle", href: "/lac/life-cycle" },
  { label: "ระบบนิเวศ & ต้นพิงอาศัย", labelEn: "Habitat & host plants", href: "/lac/habitat" },
  { label: "ต้นพิงอาศัย", labelEn: "Host plants", href: "/lac/host-plants" },
  { label: "การเพาะเลี้ยงครั่ง", labelEn: "Lac farming", href: "/lac/lac-farming" },
] as const;
...
export const AppNavbar: React.FC = () => {
  ...
  const menuButton = (label: string, active: boolean) => (
    ...
    >
      {label}
      <ChevronDown size={13} className={`shrink-0 transition-transform ${openMenu === label ? "rotate-180" : ""}`} />
    </button>
  );
        ...
        <div className="flex min-h-[60px] items-center justify-between gap-3">
          ...
          <div className="hidden min-w-0 flex-1 items-center justify-end gap-0.5 xl:flex">
            ...
            <div className="relative shrink-0" onMouseEnter={() => setOpenMenu("games")} onMouseLeave={() => setOpenMenu(null)}>
              {menuButton(t("nav.games"), isGameActive)}
