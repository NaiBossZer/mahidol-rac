...
check("question modal copy matches configured score rules", mGuidePopup.replace(/\\s+/g, " ").includes("ระดับ{difficultyRules.label} · ตอบถูก +{difficultyRules.correctScore} · ตอบผิด −{difficultyRules.incorrectPenalty}"));
